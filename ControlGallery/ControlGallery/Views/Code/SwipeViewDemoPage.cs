...
{
    public class SwipeViewDemoPage : ContentPage
    {
        ...
        public SwipeViewDemoPage()
        {
            ...
            collectionView.ItemTemplate = new DataTemplate(() =>
            {
                ...
                swipeItem.SetBinding(MenuItem.CommandProperty, new Binding("BindingContext.DeleteCommand", source: collectionView));
                swipeItem.SetBinding(MenuItem.CommandParameterProperty, ".");
                swipeView.LeftItems = new SwipeItems { swipeItem };

                Grid grid = new Grid { BackgroundColor = Colors.White, Padding = 10 };
                ...
                Label locationLabel = new Label { FontAttributes = FontAttributes.Italic, VerticalOptions = LayoutOptions.End, LineBreakMode = LineBreakMode.TailTruncation };
