namespace MonkeyApp
{
	public class MonkeysPageCode : ContentPage
	{
		public MonkeysPageCode()
		{
			...
			var image = new Image { HeightRequest = 200, WidthRequest = 200, HorizontalOptions = LayoutOptions.Center };
