namespace TextSample
{
	public class LoginPageCode : ContentPage
	{
		public LoginPageCode ()
		{
			...
			var grid = new Grid { HorizontalOptions = LayoutOptions.Fill, VerticalOptions = LayoutOptions.Fill };
			...
			grid.Add (new Entry (), 1, 0);
			grid.Add (new Entry { IsPassword = true }, 1, 1);
			grid.Add (new Button { Text = "Log In", TextColor = Colors.White, BackgroundColor = Colors.Gray }, 1, 2);
