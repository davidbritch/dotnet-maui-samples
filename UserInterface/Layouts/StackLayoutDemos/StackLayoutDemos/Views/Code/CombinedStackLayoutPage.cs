...
namespace StackLayoutDemos.Views.Code
{
    public class CombinedStackLayoutPage : ContentPage
    {
        public CombinedStackLayoutPage()
        {
            ...
            frame4StackLayout.Add(new Label { Text = "Green", FontSize = Device.GetNamedSize(NamedSize.Large, typeof(Label)), VerticalOptions = LayoutOptions.Center });
            ...
            frame5StackLayout.Add(new Label { Text = "Orange", FontSize = Device.GetNamedSize(NamedSize.Large, typeof(Label)), VerticalOptions = LayoutOptions.Center });
            ...
            frame6StackLayout.Add(new Label { Text = "Purple", FontSize = Device.GetNamedSize(NamedSize.Large, typeof(Label)), VerticalOptions = LayoutOptions.Center });
