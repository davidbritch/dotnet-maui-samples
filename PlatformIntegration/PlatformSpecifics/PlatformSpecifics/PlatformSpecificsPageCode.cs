...
{
    public class PlatformSpecificsPageCode : ContentPage
    {
        Page _originalRoot;

		public ICommand NavigateCommand { get; private set; }

        public PlatformSpecificsPageCode()
        {
		...
		async Task NavigateToPage(Type pageType)
        {
            ...
            if (info != null)
            {
                Page page = (Microsoft.Maui.Controls.Page)Activator.CreateInstance(pageType, new Command(RestoreOriginal));
            ...
            {
                Page page = (Microsoft.Maui.Controls.Page)Activator.CreateInstance(pageType);
